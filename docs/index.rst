...
This module implements NFC Forum specifications for wireless short-range data exchange with NFC devices and tags. It provides drivers for can be used with several contactless readers through USB or UART
