...
copyright = ' '.join(find_meta("copyright").split()[2:])
...
mock.patch('platform.uname', return_value=('Linux', 'kali', '3.10.0-693.21.1.el7.x86_64', '#1 SMP Wed Mar 7 19:03:37 UTC 2018', 'x86_64', 'x86_64'))
"""
...
latex_documents = [
  ('index', find_meta("title") + '.tex', find_meta("title") + ' documentation',
   find_meta("author"), 'manual'),
]
...
man_pages = [
    ('index', find_meta("title"), find_meta("title") + ' documentation',
     [find_meta("author")], 1)
]
...
texinfo_documents = [
    ('index', find_meta("title"), find_meta("title") + ' documentation',
     find_meta("author"), find_meta("title"), find_meta("description"),
     'Miscellaneous'),
]
